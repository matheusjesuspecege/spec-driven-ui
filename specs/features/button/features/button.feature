...
Funcionalidade: Button Component - Upgrade Button (Inverse)
  ...
  # ============================================================
  # VARIANTES - Inverse (Upgrade Style)
  # RF-01: Renderizar botão com variant "inverse"
  # Design: Background #FFFFFF, Text #FF5C00, radius-md (6px)
  # ============================================================
  ...
  # ============================================================
  # TAMANHO - Upgrade Button specifics
  # RF-05: Upgrade Button usa tamanho específico
  # Design: font-size 12px (text-xs), font-weight 600
  # ============================================================
  ...
  # ============================================================
  # ACESSIBILIDADE
  # RF-07: Acessibilidade para Upgrade Button
  # ============================================================
